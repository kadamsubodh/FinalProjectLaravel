      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="{{str_contains(Request::path(),'admin/productsattributes') ? 'active' : ''}} treeview">
        ...
        <!-- <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/top_nav"><i class="fa fa-circle-o"></i> Top Navigation</a></li>
            <li><a href="/boxed"><i class="fa fa-circle-o"></i> Boxed</a></li>
            <li><a href="/fixed"><i class="fa fa-circle-o"></i> Fixed</a></li>
            <li><a href="/collapsed"><i class="fa fa-circle-o"></i> Collapsed Sidebar</a></li>
          </ul>
        </li>
        <li>
          <a href="/widgets">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/generalUI"><i class="fa fa-circle-o"></i> General</a></li>
            <li><a href="/iconsUI"><i class="fa fa-circle-o"></i> Icons</a></li>
            <li><a href="/buttonsUI"><i class="fa fa-circle-o"></i> Buttons</a></li>
            <li><a href="/slidersUI"><i class="fa fa-circle-o"></i> Sliders</a></li>
            <li><a href="/timelineUI"><i class="fa fa-circle-o"></i> Timeline</a></li>
            <li><a href="/modalsUI"><i class="fa fa-circle-o"></i> Modals</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="/forms/generalForms"><i class="fa fa-circle-o"></i> General Elements</a></li>
            <li><a href="/forms/advanceForms"><i class="fa fa-circle-o"></i> Advanced Elements</a></li>
